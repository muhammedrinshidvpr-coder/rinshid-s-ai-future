...
const certifications = [
  { title: 'Advanced Prompt Engineering Certification', issuer: 'IIT Madras (IITM Pravartak)', description: 'Focused on advanced prompt design, LLM interaction, and applied AI problem-solving.', image: certIITM, featured: true },
  { title: 'Classroom of Tomorrow: Using AI and ChatGPT', issuer: 'Udemy', description: 'Focused on practical AI use in education, teaching, and productivity.', image: certUdemy, featured: false },
];
  ...
  return (
    <section id="certifications" className="section-padding relative" ref={ref}>
      <div className="container-custom">
        ...
        >
          <span className="inline-block text-accent font-medium text-sm uppercase tracking-widest mb-4">Credentials</span>
          <h2 className="font-display text-3xl md:text-4xl font-bold text-foreground mb-5">Certifications & Credentials</h2>
          <p className="text-muted-foreground text-lg leading-relaxed">Professional certifications that strengthen my expertise in AI, prompt engineering, and practical AI applications.</p>
        </motion.div>
                ...
                <div className={cert.featured ? 'md:flex' : ''}>
                  ...
                  <div className={`p-6 ${cert.featured ? 'md:w-2/5 md:flex md:flex-col md:justify-center' : ''}`}>
                    <div className="flex items-start gap-3 mb-3">
                      ...
                      <div>
                        <h3 className={`font-display font-semibold text-foreground leading-tight ${cert.featured ? 'text-xl' : 'text-lg'}`}>{cert.title}</h3>
