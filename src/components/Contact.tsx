    ...
    <section id="contact" className="section-padding relative" ref={ref}>
      <div className="container-custom">
        <div className="max-w-4xl mx-auto">
          ...
          >
            <a href="mailto:rinshidrazaq@gmail.com" className="group p-6 rounded-2xl bg-card border border-border/50 transition-all duration-300 hover:shadow-lg hover:border-accent/30 hover:-translate-y-1">
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-muted-foreground text-sm">Drop me a message for inquiries and collaborations</p>
                </div>
              </div>
            </a>
            <a href="https://wa.me/919847594827" target="_blank" rel="noopener noreferrer" className="group p-6 rounded-2xl bg-card border border-border/50 transition-all duration-300 hover:shadow-lg hover:border-accent/30 hover:-translate-y-1">
              <div className="flex items-start gap-4">
                <div className="w-12 h-12 rounded-xl bg-accent/10 flex items-center justify-center flex-shrink-0 transition-transform duration-300 group-hover:scale-110">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-muted-foreground text-sm">Quick chat for instant responses</p>
                </div>
              </div>
            </a>
          </motion.div>
